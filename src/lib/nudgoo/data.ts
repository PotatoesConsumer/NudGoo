...
export const INITIAL_STATE: State = {
  ...
  activeGroup: "gang",
  joinCode: "",
  // A single cosmetic group entry (name/emoji/colour shown in the chrome).
  // Real membership lives in Supabase `profiles`, not here.
  groups: [{ id: "gang", name: "The Gang", emoji: "🎉", color: "#3B5BDB", members: 1, unread: 0 }],
  profile: { name: "", username: "", color: "#3B5BDB", emoji: "", email: "", phone: "" },
  editField: null,
  editValue: "",
  avatarPicker: false,
  pw: { cur: "", next: "", confirm: "" },
